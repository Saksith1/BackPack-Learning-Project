...
return [
    ...
    */
    ...
    'styles' => [
        ...
        'validate-phone-numbers/css/intlTelInput.css',
        'css/widget.css',
        'css/custom.css',
    ...
    'scripts' => [
        ...
        'js/popup_image.js',
        'validate-phone-numbers/js/intlTelInput.js',
        'validate-phone-numbers/js/main.js',
        'validate-phone-numbers/js/number.js',
        'validate-phone-numbers/js/utils.js',
        'lightbox/js/lightbox-plus-jquery.min.js',
